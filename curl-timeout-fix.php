...
// Aumentar el tiempo de espera para las conexiones HTTP remotas
add_filter('http_request_timeout', function() {
    return 30; // 30 segundos de tiempo de espera
});

// Aumentar el tiempo de espera de las solicitudes cURL específicas
function custom_increase_timeout($response, $url, $class, $args, $response_object) {
    $response['timeout'] = 30; // Aumenta el tiempo de espera a 30 segundos
    return $response;
}
add_filter('http_api_debug', 'custom_increase_timeout', 10, 5);
